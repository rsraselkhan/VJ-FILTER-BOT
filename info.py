...
API_ID = int(environ.get('API_ID', '22981998'))
API_HASH = environ.get('API_HASH', 'ee0e5a596e2e61cac1fe1dbe793740cc')
BOT_TOKEN = environ.get('BOT_TOKEN', "7030833737:AAG3CI3k6H6DyxhsleyAovMJVowzBNFoZ-c")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002074405158'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6578386545').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002230404385').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1002010397102').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://emotion0852:jCzALlSIFvHAgRKe@cluster0.o8jheuu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "MongoDB")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Rasel_BOTZ')
...
SHORTLINK_API = environ.get('SHORTLINK_API', '5b3cafc70e9d4f841797849952454cdfbe4b4360')
